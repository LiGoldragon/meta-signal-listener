...
#[rustfmt::skip]
pub use signal_listener::schema::lib::ListenerDaemonConfiguration as ListenerDaemonConfiguration;
...
#[derive(rkyv::Archive, rkyv::Serialize, rkyv::Deserialize, Clone, Debug, PartialEq, Eq)]
pub enum Input {
    Configure(ListenerDaemonConfiguration),
}
...
#[rustfmt::skip]
impl Input {
    pub fn configure(payload: ListenerDaemonConfiguration) -> Self {
...
#[rustfmt::skip]
impl From<ListenerDaemonConfiguration> for Input {
    fn from(payload: ListenerDaemonConfiguration) -> Self {
        Self::Configure(payload)
    }
}
